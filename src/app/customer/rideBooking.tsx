...
const RideBooking = () => {
  ...
  const rideOptions = useMemo(() => [
    ...
    { type: "Cab Premium", seats: 4, time: '1 min', dropTime: '4:30 pm', price: farePrices?.cabPremium, isFastest: true, icon: require('@/assets/icons/cab_premium.png') },
  ], [farePrices])
  ...
  const handleRideBooking = async () => {
    ...
    await createRide({
      vehicle: selectedOption === "Cab Economy" ? "cabEconomy" : selectedOption === "cab Premium" ? "cabPremium" : selectedOption === "Bike" ? "bike" : "auto",
      drop: {
    ...
    <View style={rideStyles.container}>
      ...
      <View style={rideStyles.rideSelectionContainer}>
        <View style={rideStyles.offerContainer}>
          <CustomText fontSize={12} style={rideStyles.offerText}>You get ₹10 off 5 coin cashback</CustomText>
        </View>
        ...
        <View style={commonStyles.flexRowBetween}>
          ...
          <View style={rideStyles.couponContainer}>
            ...
            <View>
              ...
              <CustomText fontFamily='Medium' fontSize={10} style={{ opacity: 0.7 }}>Coupen Applied</CustomText>
            </View>
            <Ionicons name='chevron-forward' size={RFValue(14)} color={'#777'} />
          </View>
