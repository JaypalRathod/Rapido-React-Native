...
const LiveTrackingMap: FC<{ height: number, drop: any, pickup: any, captain: any, status: string }> = ({ height, pickup, drop, captain, status }) => {
        ...
        <View style={{ height: height, width: '100%' }}>
            ...
            >
                ...
                {captain?.latitude && pickup?.latitude && (
                    <MapViewDirections
                        origin={status === 'START' ? captain : captain}
