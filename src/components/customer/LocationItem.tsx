    ...
    return (
        ...
        >
            <View style={commonStyles.flexRow}>
                ...
                <View style={{ width: '83%' }}>
                    <CustomText fontFamily='Medium' numberOfLines={1} fontSize={12}>{item?.title}</CustomText>
                    <CustomText fontFamily='Regular' numberOfLines={1} style={{ opacity: 0.7, marginTop: 2 }} fontSize={10}>{item?.description}</CustomText>
                </View>
            </View>
